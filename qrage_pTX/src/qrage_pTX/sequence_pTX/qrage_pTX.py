...
from .inversion_pTX import InversionKernel_pTX
from .readout_pTX import ReadoutKernel_pTX
from .sampling_pTX import PartitionSampling
...
class QRAGE_pTX:
    ...
    def __init__(
        ...
        system : Opts, default=Opts()
            System limits.
        """
        Coil_shim_array = np.zeros((num_tx, 2), dtype=float)
        for i in range(num_tx):
            Coil_shim_array[i, 0] = 1 / np.sqrt(num_tx)
            Coil_shim_array[i, 1] = i * 360 / num_tx * math.pi / 180
        ...
        self.inversion_kernel = InversionKernel_pTX(
            fov,
            matrix_size,
            axes,
            num_tx=num_tx,
            Coil_shim_array=Coil_shim_array,
        ...
        self.readout_kernel = ReadoutKernel_pTX(
            fov,
            matrix_size,
            axes,
            num_tx=num_tx,
        ...
        self.num_tx = num_tx
        self.Coil_shim_array = Coil_shim_array
