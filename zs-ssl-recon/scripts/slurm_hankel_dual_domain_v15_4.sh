...
#SBATCH --output=/p/project1/drecon/qrage-dl/logs/hankel_dual_domain_v15_4.out
#SBATCH --time=12:00:00
#SBATCH --partition=dc-gpu
#SBATCH --gres=gpu:4

# chmod +x /p/project1/drecon/qrage-dl/zs-ssl-recon/scripts/slurm_hankel_dual_domain_v15_4.sh
...
# bash /p/project1/drecon/qrage-dl/zs-ssl-recon/scripts/slurm_hankel_dual_domain_v15_4.sh
# sbatch /p/project1/drecon/qrage-dl/zs-ssl-recon/scripts/slurm_hankel_dual_domain_v15_4.sh
# watch squeue --account drecon
# tail -f /p/project1/drecon/qrage-dl/logs/hankel_dual_domain_v15_4.out
...
ZS_SSL_RECON_CONFIG_FILE='/p/project1/drecon/qrage-dl/zs-ssl-recon/schemes/hankel_dual_domain_v15_4_hpc.yaml' \
